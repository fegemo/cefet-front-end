...
- Nas práticas
	...
	- Os arquivos de um computador não podiam serem visualizados em outro 
...
- Percorrendo o _array_: 
 ```php
	...
	?>
  ```
	- para imprimirmos um valor do array em uma string, devemos colocá-lo entre chaves 
...
---
## PHP e MySQL - Exemplo
- Para usarmos o MySQL no PHP precisamos, primeiramente, conectar ao MySQL: 
 ```php
	<?php
